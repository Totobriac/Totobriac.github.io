  ...
  if (player.xGrid === 16 && player.yGrid === 20) {
    switch (bossKilled) {
      ...
      default:
        ctx.font = "50px Wolf";
        ctx.fillStyle = "rgb(200,0,0)";
        ctx.fillText("La confrontation finale. ", 480, 150);
        break;
    }
  }
  if (player.xGrid === 18 && player.yGrid === 32) {
    switch (bossKilled) {
      ...
      default:
        ctx.font = "50px Wolf";
        ctx.fillStyle = "rgb(200,0,0)";
        ctx.fillText("Antre du Uber Zombi", 460, 150);
        break;
    }
  }
  if (player.xGrid === 20 && player.yGrid === 25) {
    switch (bossKilled) {
      ...
      default:
        ctx.font = "50px Wolf";
        ctx.fillStyle = "rgb(200,0,0)";
        ctx.fillText("QG de Fett Gesicht", 450, 150);
        break;
    }
  }
  if (player.xGrid === 15 && player.yGrid === 33) {
    ctx.font = "50px Wolf";
    ctx.fillStyle = "rgb(200,0,0)";
    ctx.fillText("Chez Bernacle.", 450, 150);
  }
}
